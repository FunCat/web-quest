...
function add_book(){
	...
	buf += "<div class='block_for_book'><input name=''book[] class='input_text_book' type='text'/><img src='../img/close.png' class='close_pict' onclick=\"del_book(\'.book_"+ind+"\')\"/></div>";
	buf += "</div><div class='block_book'><div class='text_book'>Электронный адрес:</div><div class='block_for_book'>";
	buf += "<input name='adres[]' class='input_text_book' type='text' style='width:400px;'/></div></div></div></div>";
